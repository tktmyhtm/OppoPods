...
class AppRfcommController {
    ...
    fun connect(device: BluetoothDevice, connectionMethod: RfcommConnectionMethod = RfcommConnectionMethod.UUID, gameModeImplementation: GameModeImplementation = GameModeImplementation.STANDARD) {
